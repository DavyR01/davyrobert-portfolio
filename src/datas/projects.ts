...
export const projects: Omit<ProjectCardProps, 'index'>[] = [
    ...
    },
    {
       ...
       tags: [
          { name: "REACT", color: "dark:text-[--primary-color]" },
          { name: "Vite.js", color: "dark:text-[--primary-color]" },
          { name: "Node.js", color: "dark:text-[--primary-color]" },
    ...
    },
    {
       ...
       tags: [
          { name: "Next.js", color: "dark:text-[--primary-color]" },
          { name: "TYPESCRIPT", color: "dark:text-[--primary-color]" },
          ...
          { name: "POSTGRESQL", color: "dark:text-[--primary-color]" },
          { name: "NGINX", color: "dark:text-[--primary-color]" },
          { name: "CADDY", color: "dark:text-[--primary-color]" },
          { name: "REDIS", color: "dark:text-[--primary-color]" },
       ],
