...
const projects = [
   {
      ...
      tags: [
         { name: "Angular", color: "dark:text-[#5ce1e6]" },
         { name: "Typescript", color: "dark:text-[#5ce1e6]" },
         { name: "C#", color: "dark:text-[#5ce1e6]" },
         { name: ".NET", color: "dark:text-[#5ce1e6]" },
         { name: "AWS", color: "dark:text-[#5ce1e6]" },
         { name: "Docker", color: "dark:text-[#5ce1e6]" },
      ],
   ...
   },
   {
      ...
      tags: [
         { name: "tag1", color: "dark:text-[#5ce1e6]" },
         { name: "tag2", color: "dark:text-[#5ce1e6]" },
         { name: "tag3", color: "dark:text-[#5ce1e6]" },
         { name: "tag1", color: "dark:text-[#5ce1e6]" },
         { name: "tag2", color: "dark:text-[#5ce1e6]" },
         { name: "tag3", color: "dark:text-[#5ce1e6]" },
         { name: "tag1", color: "dark:text-[#5ce1e6]" },
   ...
   },
   {
      ...
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. ",
      tags: [
         { name: "PHP", color: "dark:text-[#5ce1e6]" },
         { name: "tag2", color: "dark:text-[#5ce1e6]" },
         { name: "tag3", color: "dark:text-[#5ce1e6]" },
      ],
   ...
   },
   {
      ...
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
      tags: [
         { name: "React JS", color: "dark:text-[#5ce1e6]" },
         { name: "Sharepoint", color: "dark:text-[#5ce1e6]" },
      ],
