...
export const useRichTextFormatters = () => {
   ...
   const formatProjectsIntroLine1 = () => formatRichText(myProjectsT, 'introLine1');
   const formatProjectsIntroLine2 = () => formatRichText(myProjectsT, 'introLine2');

   return {
      formatContactParagraph,
      formatProjectsIntroLine1,
      formatProjectsIntroLine2
   };
};