...
export default function NotFound() {
  return (
    <>
      ...
      <main className="min-h-screen flex flex-col justify-center items-center font-grotesk font-extrabold px-4 sm:px-8 pb-20 gap-8 dark:bg-[var(--bg-dark)] dark:text-[var(--primary-color)] text-[var(--primary-color)]">
        <NavbarBackProjects />
        ...
        {/* <div className="w-full flex justify-center px-4"> */}
          <Button href="/" variant="primary" fullWidth={true} className="">
            Retour à l&apos;accueil
          </Button>
        {/* </div> */}
      </main>
