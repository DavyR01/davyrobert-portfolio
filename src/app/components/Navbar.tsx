  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-10 w-full max-w-[1400px] mx-auto bg-black">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center px-6 h-20">
        ...
        <nav
          className={`${
            menuOpen ? 'flex bg-black/90 absolute top-20 left-0 w-full py-6' : 'hidden'
        ...
        >
          <ul className="flex flex-col md:flex-row gap-6 md:gap-20 items-center list-none">
            <li>
              <a href="#home" className="hover:text-[#5EE9B5] transition-colors">
                A propos
              </a>
            </li>
            <li>
              <a href="#formation" className="hover:text-[#5EE9B5] transition-colors">
                Formation
              </a>
            </li>
            <li>
              <a href="#projets" className="hover:text-[#5EE9B5] transition-colors">
                Projets
              </a>
            </li>
            <li>
              <a href="#contact" className="hover:text-[#5EE9B5] transition-colors">
                Contact
              </a>
            </li>
          </ul>
