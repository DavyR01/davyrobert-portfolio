...
export default function Button({
  ...
  const variantClasses = {
    primary: "bg-[--primary-color] dark:text-[var(--text-color-dark)] hover:bg-[var(--bg-primary)] hover:text-[--primary-color] dark:hover:text-[--primary-color] hover:border-[--primary-color] text-[var(--text-color-light)]",
