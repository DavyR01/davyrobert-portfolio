...
//                     download
//                     className="w-full sm:w-auto text-center bg-[--primary-color] text-[var(--text-color-dark)] font-semibold py-3 px-6 rounded transition-all hover:scale-105 hover:bg-[var(--bg-primary)] hover:text-[--primary-color] hover:border-[--primary-color] border-2 border-transparent"
//                   >
...
//                               <div className="w-16 h-16 bg-blue-500 rounded-md mx-auto mb-4"></div>
...
//                           <div className="flex-1 flex items-center justify-center">
//                             <div className="text-center">
//                               <div className="w-16 h-16 bg-cyan-500 rounded-md mx-auto mb-4"></div>
