         ...
         <div id="presentation" className="relative z-10 w-full max-w-[700px] text-left mb-8 lg:mb-0">
            ...
            <div className="text-base mb-8 dark:text-gray-300 text-gray-700 space-y-4">
               <p>
                  ...
                  Épris par le monde de l&apos;<span className="keyword-highlight">entrepreneuriat</span> et les <span className="keyword-highlight">nouvelles technologies</span>, je me forme <span className="font-semibold">continuellement</span> et évolue <span className="font-semibold">constamment</span> selon les compétences requises et la demande sur le marché.
               </p>
               
               <p>
                  Je <span className="keyword-highlight">conçois</span>, <span className="keyword-highlight">développe</span> et <span className="keyword-highlight">optimise</span> des applications web, d&apos;une <span className="font-semibold">idée</span> à la réalisation jusqu&apos;à la <span className="font-semibold">mise en production</span>.
                  Je consacre du temps à me former en <span className="keyword-highlight">autodidacte</span> et m&apos;adapte en permanence aux <span className="font-semibold">innovations</span> et <span className="font-semibold">nouvelles technologies émergentes</span>. <br /> Je vise donc à exploiter celles qui s&apos;avèrent pertinentes pour mener à bien les missions qui me sont confiées.
               </p>
               
               <p>
                  De ce fait, je souhaite apporter ma contribution dans des <span className="keyword-highlight">projets ambitieux</span> et porteurs de <span className="keyword-highlight">transformations</span>, auprès d&apos;<span className="font-semibold">entreprises engagées</span> et partageant des <span className="font-semibold">valeurs fortes</span>.
               </p>
