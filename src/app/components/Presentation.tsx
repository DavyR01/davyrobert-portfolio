      ...
      <div>
         ...
         >
            ...
            <div id="presentation" className="flex flex-col gap-3 relative z-10 w-full  text-left mb-8 lg:mb-0">
               ...
               <div className={`text-base text-[var(--text-color-dark)] dark:text-[var(--text-color-main)] space-y-4 ${locale === 'fr' ? 'xl:space-y-6 xl:leading-[2.1rem]' : 'xl:leading-[2.08rem]'} leading-[1.65rem] space-y-6 lg:leading-normal text-justify`}>
